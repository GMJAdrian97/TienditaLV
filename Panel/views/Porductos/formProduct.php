...
<div id="container">
    ...
    <form method="POST"
        ...
        <div class="marca">
            ...
            <select class="custom-select" id="validatedInputGroupSelect" name="id_marca" required>
                ...
                <?php foreach ($datosMarca as $key => $value): 
                                    $selected = "";
                                    if($value['nombre'] == $datosFormulario['nombre']):
                                      $selected = "selected";
                                    endif;
                                  ?>
                <option value="<?php echo $value['id_marca'];?>" <?php echo $selected; ?>> <?php echo $value['nombre']?> </option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="categoria">
        ...
        <div class="descripcion">
            ...
            <textarea name="descripcion" placeholder="DESCRIPCION" id="message_input" cols="30" rows="5"
                required></textarea>
        </div>
        <div class="submit">
